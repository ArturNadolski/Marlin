...
namespace Language_pl {
  ...
  PROGMEM Language_Str MSG_LASER_MENU                      = _UxGT("Sterowanie laserem");
  ...
  PROGMEM Language_Str MSG_M48_POINT                       = _UxGT("M48 Punkty");
  ...
  PROGMEM Language_Str MSG_UBL_BC_REMOVE                   = _UxGT("Usuń i zmierz stół");
  ...
  PROGMEM Language_Str MSG_UBL_BED_TEMP_CUSTOM             = _UxGT("Temperatura stołu własna");
  PROGMEM Language_Str MSG_UBL_SET_TEMP_HOTEND             = _UxGT("Temperatura dyszy");
  PROGMEM Language_Str MSG_UBL_HOTEND_TEMP_CUSTOM          = _UxGT("Temperatura dyszy własna");
  ...
  PROGMEM Language_Str MSG_UBL_DONE_EDITING_MESH           = _UxGT("Koniec edycji siatki");
  PROGMEM Language_Str MSG_UBL_BUILD_CUSTOM_MESH           = _UxGT("Buduj własną siatkę");
  ...
  PROGMEM Language_Str MSG_G26_FIXED_LENGTH                = _UxGT("Napełnij określoną długością");
  ...
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP                  = _UxGT("Wyślij mapę siatki");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP_HOST             = _UxGT("Wyślij do Hosta");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP_CSV              = _UxGT("Wyślij do CSV");
  PROGMEM Language_Str MSG_UBL_OUTPUT_MAP_BACKUP           = _UxGT("Kopia poza drukarką");
  PROGMEM Language_Str MSG_UBL_INFO_UBL                    = _UxGT("Wyślij info UBL");
  ...
  PROGMEM Language_Str MSG_UBL_NO_STORAGE                  = _UxGT("Brak pamięci");
  ...
  PROGMEM Language_Str MSG_SET_LEDS_YELLOW                 = _UxGT("Żółty");
  ...
  PROGMEM Language_Str MSG_MOVE_E                          = _UxGT("Ekstruzja (oś E)");
  PROGMEM Language_Str MSG_MOVE_EN                         = _UxGT("Ekstruzja (oś E) *");
  PROGMEM Language_Str MSG_HOTEND_TOO_COLD                 = _UxGT("Dysza za zimna");
  PROGMEM Language_Str MSG_MOVE_Z_DIST                     = _UxGT("Przesuń o %smm");
  PROGMEM Language_Str MSG_MOVE_01MM                       = _UxGT("Przesuń o .1mm");
  PROGMEM Language_Str MSG_MOVE_1MM                        = _UxGT("Przesuń o 1mm");
  PROGMEM Language_Str MSG_MOVE_10MM                       = _UxGT("Przesuń o 10mm");
  PROGMEM Language_Str MSG_SPEED                           = _UxGT("Prędkość");
  ...
  PROGMEM Language_Str MSG_E_STEPS                         = _UxGT("kroki E/mm");
  ...
  PROGMEM Language_Str MSG_REFRESH                         = LCD_STR_REFRESH  _UxGT("Odśwież");
  ...
  PROGMEM Language_Str MSG_BUTTON_INIT                     = _UxGT("Inicj.");
  ...
  PROGMEM Language_Str MSG_SKEW_FACTOR                     = _UxGT("Współczynnik skrzywienia");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_5V           = _UxGT("Ustaw BLTouch 5V");
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_OD           = _UxGT("Ustaw BLTouch OD");
  ...
  PROGMEM Language_Str MSG_TOUCHMI_INIT                    = _UxGT("Inicj. TouchMI");
  PROGMEM Language_Str MSG_TOUCHMI_ZTEST                   = _UxGT("Z Offset Test");
  PROGMEM Language_Str MSG_TOUCHMI_SAVE                    = _UxGT("Zapisz");
  ...
  PROGMEM Language_Str MSG_INFO_BAUDRATE                   = _UxGT("Prędkość USB");
  PROGMEM Language_Str MSG_INFO_PROTOCOL                   = _UxGT("Protokół");
  PROGMEM Language_Str MSG_INFO_RUNAWAY_OFF                = _UxGT("Zegar pracy: Wył.");
  PROGMEM Language_Str MSG_INFO_RUNAWAY_ON                 = _UxGT("Zegar pracy: Wł.");
  ...
  //
  #if LCD_HEIGHT >= 4
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_WAITING        = _UxGT(MSG_2_LINE("Naciśnij przycisk", "aby wznowić drukowanie"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Włóż filament", "i naciśnij przycisk", "aby kontynuować"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_2_LINE("Kliknij aby zakończyć", "oczyszczanie filamentu"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_1_LINE("Kliknij aby zakończyć"));
  ...
  PROGMEM Language_Str MSG_TMC_CURRENT                     = _UxGT("Prąd");
  ...
  PROGMEM Language_Str MSG_TMC_STEPPING_MODE               = _UxGT("Tryb pracy");
  PROGMEM Language_Str MSG_TMC_STEALTH_ENABLED             = _UxGT("StealthChop Włączony");
  PROGMEM Language_Str MSG_SERVICE_RESET                   = _UxGT("Reset");
  PROGMEM Language_Str MSG_SERVICE_IN                      = _UxGT(" w:");
  ...
  PROGMEM Language_Str MSG_BACKLASH_SMOOTHING              = _UxGT("Wygładanie");
}
